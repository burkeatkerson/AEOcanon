...
const AUTHORITY = [
  ...
  },
  {
    n: "The library",
    h: "Education Center",
    p: "Answer-first guides small-business owners and marketers learn from.",
    href: "/learn",
    color: "var(--c3)",
  },
  {
    n: "The paths",
    h: "Guided courses",
    p: "Ordered curricula that take you from fundamentals to shipping.",
    href: "/paths",
    color: "var(--c2)",
  },
  {
    n: "By industry",
    h: "Vertical playbooks",
    p: "How AEO and SEO apply to your field, drawn from the library.",
    href: "/verticals",
    color: "var(--c6)",
  },
];
